...
window.LAPIS_CONFIG = Object.freeze({
  ...
  SITE_NAME: 'LAPIS — Layanan Akses Publik Indikator Strategis Kota Pontianak',
  SHORT_NAME: 'LAPIS',
  ...
  PAGES: Object.freeze({
    home: {
      ...
      description: 'LAPIS (Layanan Akses Publik Indikator Strategis Kota Pontianak) menyajikan indikator strategis Kota Pontianak untuk pemerintah, akademisi, peneliti, dan pengguna data.'
    },
    inflasi: {
